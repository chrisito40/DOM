...
Acceder a este objecto usando la notación de punto.

 nodo.style

 Resultado es CSS Style Declaration. Es 
 lista que represanta todas las propiedades de un
 estilo de un elemento.

Las propiedades cambian del formato kebab-case a
camelCase.
 ...
 */
   ...
   console.log("El color del titulo" + titulo.style.color);
...
/* 
 ...
 Eliminar valores de propiedades del nodo seleccionado
    ...
    node.style.nombrePropiedad = "" // Asignamos una cadena vacía

    En esta sintaxis, la propiedad de CSS ve en formato camelCase.
